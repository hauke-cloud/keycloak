...
- Managed via OLM Keycloak operator
- Storage via cloudnative-pg Postgres operator
...
```bash
git clone https://github.com/hauke-cloud/keycloak.git
```
...
```bash
helm template oci://ghcr.io/hauke-cloud/charts/keycloak
```

#### Deploy the Helm chart

```bash
helm install keycloak oci://ghcr.io/hauke-cloud/charts/keycloak --version 1.0.0
```
